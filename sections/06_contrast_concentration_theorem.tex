...
application of a canonically normalized incidence operator.  It does
not prove that the native Thalean mechanics repeatedly applies this
operator to a physical state.

The theorem object is therefore:

\[
\text{exact contrast concentration under }\widehat{Q}.
\]

The open crosswalk is:

\[
\text{native admitted loading}
